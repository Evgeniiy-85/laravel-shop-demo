<div class="btn-wrap">
    <a href="/cart" class="btn-cart">
        <i class="btn-icon"></i>
        <i class="count-products-icon @if(!$cart->count_products) hidden @endif">{{ $cart->count_products }}</i>
    ...
    @if($cart->products)
        <div class="modal has-products" id="cart_modal">
                                    ...
                                    <div class="cart-product" data-prod_id="{{ $product->prod_id }}">
                                        ...
                                        <div class="cart-product_info">
                                            ...
                                            <div class="cart-product-quantity_pickers">
                                                <button wire:click="reduce({{ $product->prod_id }})" wire:click.prevent="updateByButton" class="cart-product-quantity_picker btn_a-primary" data-prod_id="{{ $prod_id }}" data-action_type="reduce">
                                                    <i class="fa fa-minus"></i>
                                                </button>
                                                <div class="cart-product-quantity">{{ $quantity }}</div>
                                                <button wire:click="append({{ $product->prod_id }})" wire:click.prevent="updateByButton" class="cart-product-quantity_picker btn_a-primary" data-prod_id="{{ $prod_id }}" data-action_type="append">
                                                    <i class="fa fa-plus"></i>
                                                </button>
                                            </div>

                                            <a wire:click="remove({{ $product->prod_id }})" href="javascript:void(0);" wire:click.prevent="updateByButton" class="cart-product_remove" data-prod_id="{{ $prod_id }}"  data-action_type="product_remove">

                                    ...
                                    <div class="cart-product" data-id="{{ $product->id }}">
                                        ...
                                        <div class="cart-product_info">
                                            ...
                                            <div class="cart-product-quantity_pickers">
                                                <button wire:click="reduce({{ $product->id }})" wire:click.prevent="updateByButton" class="cart-product-quantity_picker btn_a-primary" data-id="{{ $id }}" data-action_type="reduce">
                                                    <i class="fa fa-minus"></i>
                                                </button>
                                                <div class="cart-product-quantity">{{ $quantity }}</div>
                                                <button wire:click="append({{ $product->id }})" wire:click.prevent="updateByButton" class="cart-product-quantity_picker btn_a-primary" data-id="{{ $id }}" data-action_type="append">
                                                    <i class="fa fa-plus"></i>
                                                </button>
                                            </div>

                                            <a wire:click="remove({{ $product->id }})" href="javascript:void(0);" wire:click.prevent="updateByButton" class="cart-product_remove" data-id="{{ $id }}"  data-action_type="product_remove">

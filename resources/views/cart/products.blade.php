                ...
                <div class="cart-product" data-id="{{ $product->id }}">
                    ...
                    <div class="cart-product_info">
                        ...
                        <div class="cart-product-quantity_pickers">
                            <a href="javascript:void(0);" class="cart-product-quantity_picker btn_a-primary" data-id="{{ $id }}" data-action_type="reduce">
                                <i class="fa fa-minus"></i>
                            </a>
                            <div class="cart-product-quantity">{{ $quantity }}</div>
                            <a href="javascript:void(0);" class="cart-product-quantity_picker btn_a-primary" data-id="{{ $id }}" data-action_type="append">
                                <i class="fa fa-plus"></i>
                            </a>
                        </div>
                        <a href="javascript:void(0);" class="cart-product_remove" data-id="{{ $id }}"  data-action_type="product_remove">
